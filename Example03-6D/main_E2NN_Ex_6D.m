function E2NN_Ex_6D_v02_parfor_SN500()
...
%     load temp_result_6D_SN100.mat
%     load temp_result_6D_SN200.mat
%     load temp_result_6D_SN300.mat
%     load temp_result_6D_SN500.mat
    
    load(['temp_result_6D_SN' int2str(Sn) '.mat'])
else
    ...
    NNs=[nd 30 30 1]; %number of neurons at each layer
    ...
    if save_results
        save(['temp_result_6D_SN' int2str(Sn) '.mat'])
    end
end
...
scatter(Yp_net(:),testYsn,10,'filled','MarkerEdgeColor','k','MarkerFaceColor','m')
scatter(testYp,testYsn,10,'filled','MarkerEdgeColor','k','MarkerFaceColor','b')

div1=(testYsn-testYp)./testYp;
div2=(testYsn-Yp_net(:))./testYp;
figure, hold on
h2=histogram(div2,20,'FaceColor','m','EdgeColor','k' );
h1=histogram(div1,20,'FaceColor','b','EdgeColor','k');

figure, hold on
pd1 = fitdist(div1,'Normal');
pd2 = fitdist(div2,'Normal');
x_values = -400:1:400;
y = pdf(pd1,x_values);
plot(x_values,y,'b','LineWidth',2)
y = pdf(pd2,x_values);
plot(x_values,y,'m','LineWidth',2)
