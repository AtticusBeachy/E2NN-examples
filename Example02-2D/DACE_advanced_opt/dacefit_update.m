function  [dmodel, perf] = dacefit_update(S, Y, regr, corr, theta0, lob, upb)
...
options = optimoptions('patternsearch',...
                       'MaxFunctionEvaluations', 100*Ndim, ...
                       'MeshTolerance',1e-6,...
...
[THopt_exp, ~] = fmincon(@(THexp)objfunc(10.^THexp, par),THexp_init_ptrn,...
                                         [],[],[],[],lo,up,[],options);
time_local = toc
